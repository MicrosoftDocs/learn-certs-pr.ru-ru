...
- Войдите в свою панель сертификации [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx).
...
С отчетами о результатах можно ознакомиться на вашей панели сертификации [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx).

- Войдите в свою панель сертификации [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx).
- Выберите **Просмотреть мой отчет о результатах**. В этом разделе можно сохранить и распечатать отчет с оценками.
...
Чтобы начать экзамен, войдите в свою панель сертификации [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) и нажмите **Начать запланированный ранее онлайн-экзамен**. Вы будете перенаправлены на страницу Pearson VUE, где можно просмотреть информацию о запланированном экзамене и приступить к выполнению заданий.
